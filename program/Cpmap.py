...
#
pll = np.ma.array ( p_LL, mask=np.isnan(p_LL)) 
plh = np.ma.array ( p_LH, mask=np.isnan(p_LH)) 
#%%
#norm=colors.PowerNorm(10)
plt.figure(figsize=(8,4))
#
plt.pcolormesh(v_LL, e_LL/1e3, pll/1000, cmap='jet',shading='gouraud')
plt.clim(0.1,10)
plt.pcolormesh(v_LH, e_LH/1e3, plh/1000, cmap='jet',shading='gouraud')
plt.clim(0.1,10)
#plt.pcolormesh(v_R, e_R/1e3, p_R/1000, cmap='jet',shading='gouraud')
#plt.clim(100,900)
#plt.pcolormesh(v_HT, e_HT/1e3, p_HT/1000, cmap='jet',shading='gouraud')
#plt.clim(100,900)
