...
#
plt.pcolormesh(v_R, e_R/1e3, p_R/1e6, cmap='jet',shading='gouraud')
plt.clim(0.1,40)
plt.pcolormesh(v_LL, e_LL/1e3, p_LL/1e6, cmap='jet',shading='gouraud')
plt.clim(0.1,40)
plt.pcolormesh(v_LH, e_LH/1e3, p_LH/1e6, cmap='jet',shading='gouraud')
plt.clim(0.1,40)
plt.pcolormesh(v_TP, e_TP/1e3, p_TP/1e6, cmap='jet',shading='gourand')
plt.clim(0.1,40)
plt.pcolormesh(v_HT, e_HT/1e3, p_HT/1e6, cmap='jet',shading='gouraud')
plt.clim(0.1,40)
...
plt.text(3.3e-1,550, ' MPa', fontsize=11,fontweight='bold')
