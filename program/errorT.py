...
#
########################LL############################################
data_LL = np.loadtxt("err_TBL_LL.txt")
eLL=[]
vLL=[]
PLL=[]
eLL=data_LL[:,0]
...
###############################LH####################################
data_LH = np.loadtxt("err_TBL_LH.txt")
eLH=[]
vLH=[]
PLH=[]
eLH=data_LH[:,0]
...
#
###############################HT#####################################
data_HT = np.loadtxt("err_TBL_HT.txt")
eHT=[]
vHT=[]
PHT=[]
eHT=data_HT[:,0]
...
#########################R###########################################
data_R = np.loadtxt("err_TBL_R.txt")
eR=[]
vR=[]
PR=[]
eR=data_R[:,0]
